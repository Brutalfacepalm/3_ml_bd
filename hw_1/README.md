...
###### Для корректного запуска пришлось немного модифиривать файлик [docker-compose.yml.](https://github.com/Brutalfacepalm/3_ml_bd/blob/master/hw_1/docker-hadoop/docker-compose.yml) и соответствующие DockerFile######
